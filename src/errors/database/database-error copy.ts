...
//   constructor({ functionName, message, code, cause, metadata }: DatabaseErrorDetails) {
...
//   static connectionError({ functionName, message, cause, metadata }: Omit<DatabaseErrorDetails, "code">): DatabaseError {
...
//   static queryError({ functionName, message, cause, metadata }: Omit<DatabaseErrorDetails, "code">): DatabaseError {
//     return new DatabaseError({
//       functionName,
//       message,
...
//   static dataIntegrityError({ functionName, message, cause, metadata }: Omit<DatabaseErrorDetails, "code">): DatabaseError {
//     return new DatabaseError({
//       functionName,
//       message,
...
//   static recordNotFoundError({ functionName, message, cause, metadata }: Omit<DatabaseErrorDetails, "code">): DatabaseError {
//     return new DatabaseError({
//       functionName,
//       message,
